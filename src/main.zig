...
fn infoCommand(allocator: mem.Allocator) !void {
    ...
    std.debug.print("  G-Sync Compatible:  GTX 1000+, driver 440+ (595+ recommended)\n", .{});
    std.debug.print("  HDMI 2.1 VRR:       RTX 3000+, driver 470+ (595+ recommended)\n", .{});
    std.debug.print("  Note: Driver 595+ (open kernel modules) has improved VRR and Wayland support\n", .{});
